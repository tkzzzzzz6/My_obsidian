...
1. [A Survey on Agentic Multimodal Large Language Models](https://www.alphaxiv.org/abs/2510.10991)(介绍了能够跨越视觉、语言等多种模态进行感知和行动的智能体技术)
2. [Agentic Reasoning for Large Language Models](https://www.alphaxiv.org/abs/2601.12538)(探索使大语言模型能够在开放世界环境下进行复杂推理的基础认知过程)
3. [The Landscape of Agentic Reinforcement Learning for LLMs: A Survey](https://www.alphaxiv.org/abs/2509.02547)(综述了强化学习如何从被动的模型训练转向主动的智能体性能优化。)
